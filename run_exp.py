...
import ether_temporal_dl as eth_temp
...
def build_dataset(args):
	...
	elif args.data == 'ethereum':
		return eth.ethereum_dataset(args)
	...
	elif args.data == 'ether_temporal':
		return eth_temp.EtherTemporalDataset(args)
...
def build_gcn(args,tasker):
	...
	if args.model == 'gcn':
		...
		if args.model == 'lstmA':
			...
			return egcn_h.EGCN(gcn_args, activation = torch.nn.RReLU()).to(args.device)
